...
(function() {
  ...
  Twitter = (function() {
    function Twitter(selector, username, count) {
      ...
      if (this.target != null) {
        $.ajax({
          url: "http://twitter-zacharydenton.herokuapp.com/?trim_user=true&count=" + (this.count + 10) + "&include_entities=1&exclude_replies=true&callback=?",
          dataType: "jsonp",
          error: function(err) {
